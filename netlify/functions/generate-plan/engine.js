...
} = require('./request-validation.js');
const { fetchPlanGenerationData } = require('./repositories.js');
...
module.exports.analyzeRpeTrend = analyzeRpeTrend;
module.exports.buildRollingPlan = buildRollingPlan;
module.exports.validateAndCorrectPlan = validateAndCorrectPlan;
module.exports.estimateSessionDurationSeconds = estimateSessionDurationSeconds;
module.exports.calculateScoreComponents = calculateScoreComponents;
